...
TileEngine = function(ctx, ground, building, p_oLevel) {	
		...
		for (var r = 0; r < mapInformations.rowTileCount; r++) {
			for (var c = 0; c < mapInformations.colTileCount; c++) {
				...
				ctx.drawImage(ground, (tileCol * mapInformations.tileSize), (tileRow * mapInformations.tileSize), mapInformations.tileSize, mapInformations.tileSize, (c * mapInformations.tileSize), (r * mapInformations.tileSize), mapInformations.tileSize, mapInformations.tileSize);
				...
				var tileRow = (tile / mapInformations.imageNumTiles) | 0;
				var tileCol = (tile % mapInformations.imageNumTiles) | 0;
				ctx.drawImage(building, (tileCol * mapInformations.tileSize), (tileRow * mapInformations.tileSize), mapInformations.tileSize, mapInformations.tileSize, (c * mapInformations.tileSize), (r * mapInformations.tileSize), mapInformations.tileSize, mapInformations.tileSize);
		}
	}
}